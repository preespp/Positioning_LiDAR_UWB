...
public:
  WheelMotorNode() : Node("wheel_motor_node") {
    ...
    cmd_sub_ = this->create_subscription<your_package_name::msg::WheelCommand>(
        "/wheel_cmd", 10,
...
private:
  ...
  void cmd_callback(const your_package_name::msg::WheelCommand::SharedPtr msg) {
  ...
  int serial_fd_;
  rclcpp::Subscription<your_package_name::msg::WheelCommand>::SharedPtr cmd_sub_;
};
